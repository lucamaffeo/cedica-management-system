...
def run():
    ...
    jinete2 = riders.create_rider(name="Pedro", surname="Gonzalez", dni=98765432, age=30, birthdate="1991-01-01", birth_place="CABA", address="Calle Falsa 456", phone="987654321", emergency_contact="Ana", emergency_contact_phone_number="987654321", scholarship=False, scholarship_percentage=0, professionals="Dr. Pedro Gonzalez", disability_certificate=False, diagnosis="ECNE", other="Otro", disability_type="Mental", family_assignment=True, pension="Provincial", health_insurance="OSDE", affiliate_number="654321", guardianship=False, observations="Sin observaciones", school_institution="Escuela 456", institution_address="Calle Falsa 456", grade="Segundo", institution_phone="987654321", institution_observations="Sin observaciones", horse_id=caballo1.id, horse_conductor_id=conductor.id, track_assistant_id=auxiliar_pista.id, therapist_teacher_id=terapeuta.id, work_proposal="Hipoterapia", condition="Regular", headquarters="CASJ")
    ...
    #Contenidos
    contenido1 = content.create_content(title="Titulo1", summary="Resumen1", content="Contenido1", author_id=1, status_id=2, publication_date="2024-01-01")
    contenido3 = content.create_content(title="Titulo3", summary="Resumen3", content="Contenido3", author_id=1, status_id=2, publication_date="2024-03-01")
    contenido4 = content.create_content(title="Titulo4", summary="Resumen4", content="Contenido4", author_id=1, status_id=2, publication_date="2024-04-01")
    contenido5 = content.create_content(title="Titulo5", summary="Resumen5", content="Contenido5", author_id=1, status_id=2, publication_date="2024-05-01")
    contenido6 = content.create_content(title="Titulo6", summary="Resumen6", content="Contenido6", author_id=1, status_id=2, publication_date="2024-06-01")
    contenido7 = content.create_content(title="Titulo7", summary="Resumen7", content="Contenido7", author_id=1, status_id=2, publication_date="2024-07-01")
    contenido8 = content.create_content(title="Titulo8", summary="Resumen8", content="Contenido8", author_id=1, status_id=2, publication_date="2024-08-01")
    contenido7 = content.create_content(title="Titulo7", summary="Resumen7", content="Contenido7", author_id=1, status_id=2, publication_date="2024-07-01")
    contenido8 = content.create_content(title="Titulo8", summary="Resumen8", content="Contenido8", author_id=1, status_id=2, publication_date="2024-08-01")

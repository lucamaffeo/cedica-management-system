...
def run():
    ...
    _ = contact.create_contact(title="Consulta general", email="test@test1.com", description="Consulta sobre servicios disponibles", status_id=1)
    _ = contact.create_contact(title="Consulta general", email="test@test2.com", description="Consulta sobre servicios disponibles", status_id=1)
    _ = contact.create_contact(title="Consulta general", email="test@test3.com", description="Consulta sobre servicios disponibles", status_id=1)
    _ = contact.create_contact(title="Consulta general", email="test@test4.com", description="Consulta sobre servicios disponibles", status_id=1)
    _ = contact.create_contact(title="Consulta general", email="test@test5.com", description="Consulta sobre servicios disponibles", status_id=1)
    _ = contact.create_contact(title="Consulta general", email="test@test6.com", description="Consulta sobre servicios disponibles", status_id=1)
    _ = contact.create_contact(title="Consulta general", email="test@test7.com", description="Consulta sobre servicios disponibles", status_id=1)
    _ = contact.create_contact(title="Consulta general", email="test@test8.com", description="Consulta sobre servicios disponibles", status_id=1)
    _ = contact.create_contact(title="Consulta general", email="test@test9.com", description="Consulta sobre servicios disponibles", status_id=1)
    _ = contact.create_contact(title="Consulta general", email="test@test10.com", description="Consulta sobre servicios disponibles", status_id=1)
    _ = contact.create_contact(title="Consulta general", email="test@test11.com", description="Consulta sobre servicios disponibles", status_id=1)
